...
from steps.config import ModelNameConfig  # Add this import at the top
...
def continuous_deployment_pipeline(
    data_path: str,  # Now used correctly
    min_accuracy: float = 0.9,
    workers: int = 1,
    timeout: int = DEFAULT_SERVICE_START_STOP_TIMEOUT,
):
    # Link all the steps artifacts together
    df = ingest_data(data_path=data_path)  # ✅ Fix applied here!
    ...
    logger.info(f"Deployment Decision: {'Deploying Model' if deployment_decision else 'Skipping Deployment'}")
